...
//    }
  ...
  Ability getAbility(Track track, bool shift, bool alt, bool ctrl){
    ...
    for(Ability ability in possibles){
      if((actions < ability.actions) || (track.fields.length - 1 > ability.getPossiblesSteps() - far) ||
      (far > ability.getPossiblesSteps()) || (ability.freeWayNeeded() && track.isEnemy(player))){
