...
import '../shelf_web_socket/shelf_web_socket.dart' as sWs;
...
void main(List<String> args){
  runZoned((){
    ...
    var pathToBuild = join(dirname(Platform.script.toFilePath().replaceAll("deskovka_server\\bin", "deskovka_client")), 'web');
